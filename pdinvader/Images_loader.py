...
class ImgLoader:
    ...
    def __load(self):
        ...
        self.lifeimages=[]
        for a in range(3):
            self.lifeimages.append(pygame.image.load(f"pdinvader/Images/Life/life{a+1}.png"))
            self.lifeimages[a]=pygame.transform.scale(self.lifeimages[a],(100,30))
        ...
        self.winimg=pygame.transform.scale(self.winimg,(self.Screen_Width,self.Screen_Height))
